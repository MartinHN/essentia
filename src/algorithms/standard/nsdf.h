...
#ifndef ESSENTIA_NSDF_H
#define ESSENTIA_NSDF_H
...
class Nsdf : public Algorithm {
 ...
 public:
  Nsdf() : _fftBuffer(0), _corr(0), _paddedSignal(0) {
    declareInput(_signal, "array", "the array to be analyzed");
    declareOutput(_correlation, "nsdf", "the NSDF vector");
...
class Nsdf : public StreamingAlgorithmWrapper {
