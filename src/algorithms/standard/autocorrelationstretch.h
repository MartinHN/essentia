...
#ifndef ESSENTIA_AUTOCORRELATIONSTRETCH_H
#define ESSENTIA_AUTOCORRELATIONSTRETCH_H
...
class AutoCorrelationStretch : public Algorithm {
 ...
 public:
  ...
  void declareParameters() {
    declareParameter("stretch", "stretching power", "(-inf,inf)", 0.8);
    declareParameter("timeM", "stretching mult", "(-inf,inf)", 2.0);
  }
...
class AutoCorrelationStretch : public StreamingAlgorithmWrapper {
